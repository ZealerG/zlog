    ...
    <div className="md:hidden">
      ...
      {open ? (
        <div className="pointer-events-auto fixed inset-0 z-[60] md:hidden">
          ...
          />
          <div className="animate-soft-panel-in-mobile glass-panel absolute inset-x-3 top-3 overflow-hidden rounded-3xl dark:!bg-[linear-gradient(165deg,rgb(24_24_27/0.88),rgb(9_9_11/0.92))]">
